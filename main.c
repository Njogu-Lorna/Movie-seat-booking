...
int movie(void)
{
	...
	printf("\t\t\tpress 2 for Joker\n\n");
	printf("\t\t\tpress 3 for Toy Story 4\n");
        printf("\t\t\tpress 4 for The Lion King\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Joker\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 22-11-2020\n");
        printf("\t                                              Time      : 09:00pm\n");
        printf("\t                                              Hall      : 03\n");
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Toy Story 4\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 23-11-2020\n");
        printf("\t                                              Time      : 10:00pm\n");
        printf("\t                                              Hall      : 04\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : The Lion King\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 23-11-2020\n");
        printf("\t                                              Time      : 10:00pm\n");
        printf("\t                                              Hall      : 04\n");
